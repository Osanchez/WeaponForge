This is a mod that allows the user to create .JSON files to create weapons for the game PUNK (v0.12.10) instead of coding a .dll file and making patches to add weapons to the game. This is a quick and dirty creation by Claude Code Fable with access to the .dll files of the game. 

This requires BepInEx to run properly, check out the PunkMods https://github.com/Osanchez/PunkMods for a better explaination on how to setup mods for this game.
